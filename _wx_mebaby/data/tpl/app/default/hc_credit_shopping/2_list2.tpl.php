...
<div class="g-body">
    <div class="m-list">
        ...
        <div class="g-wrap g-body-bd">
			...
			<div data-pro="more"><div class="w-more" id="pro-view-13"><div data-pro="link"><a href="javascript:void(0);">没有商品了</a></div><div data-pro="loading" style="display:none"><b class="ico ico-loading"></b> 努力加载中</div><div data-pro="disable" style="display:none">已经没有更多</div></div></div></div></div>
        </div>
    </div>
</div>
