...
<ul class="nav nav-tabs">
    ...
    <li <?php  if($operation == 'export') { ?>class="active"<?php  } ?>>
        <a href="<?php  echo $this->createWebUrl('order', array('op' => 'export', 'status' => -1))?>">订单导出</a>
    </li>
</ul>
    ...
    <div class="panel panel-info">
	    ...
	    <div class="panel-body">
            <form action="./index.php" method="get" class="form-horizontal" role="form" id="form1">
                ...
                <input type="hidden" name="m" value="hc_credit_shopping" />
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9 col-xs-12">
						<p class="form-control-static"><?php  echo $item['price'];?> 积分 </p>
					</div>
				</div>
				<div class="form-group">
				...
				<table class="table table-hover">
					...
					<tr>
						<td colspan="10" class="text-right">
							...
							<button type="submit" class="btn btn-primary" onclick="return confirm('确认确定已经发货吗？'); return false;" name="send" value="yes">确认发货</button>
							<?php  } ?>
