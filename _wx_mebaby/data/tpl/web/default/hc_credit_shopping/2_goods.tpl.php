...
<link type="text/css" rel="stylesheet" href="../addons/hc_credit_shopping/images/uploadify_t.css" />
<style type='text/css'>
		...
		<form action="./index.php" method="get" class="form-horizontal" role="form">
			...
			<div class="form-group">
				...
				<div class="col-sm-8 col-xs-12">
					...
					<select class="form-control tpl-category-parent" id="category_parent" name="category[parentid]">
