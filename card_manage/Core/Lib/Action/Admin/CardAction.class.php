            ...
            if($rs){
                ...
                if($rsArr['ret'] == 200){
                    ...
                    if($orderTotal >= 4000){
                        ...
                        $wechat_token = file_get_Contents("http://wechat.mebaby.cn/app/index.php?i=2&c=entry&do=gettoken&m=member");
                        ...
                        if($res['errcode'] != 0){
                            ...
                            $this->error("对不起，发送失败，错误编号：WE01 ".$result.$wechat_http." <br  /> ".$wechat_token."<br /> http://wx.mebaby.cn/app/index.php?i=2&c=entry&m=member&do=gettoken");
