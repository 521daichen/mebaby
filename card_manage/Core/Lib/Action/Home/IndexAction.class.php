        ...
        if($orderObj['ret'] == 200 && $orderObj['data']){
            ...
            foreach($orderArr as $key => $val){
                ...
                foreach($val['items'] as $k => $v) {
                    ...
                    $sql = "insert into tp_order_detail_bk ( shopName, eod ,cashierUid , customerUid,sn,datetime,totalAmount,totalProfit,discount,rounding,ticketType,invalid,item_name,item_buyPrice,item_sellPrice,item_customerPrice,item_quantity,item_discount,item_customerDiscount,item_totalAmount,item_totalProfit,item_isCustomerDiscount,item_productUid,item_ticketitemattributes,create_time) value ('".$shopName."','".$date."','".$val['cashierUid']."','".$val['customerUid']."','".$val['sn']."','".$val['datetime']."','".$val['totalAmount']."','".$val['totalProfit']."','".$val['discount']."','".$val['rounding']."','".$val['ticketType']."','".$val['invalid']."','". addslashes($v['name'])."','".$v['buyPrice']."','".$v['sellPrice']."','".$v['customerPrice']."','".$v['quantity']."','".$v['discount']."','".$v['customerDiscount']."','".$v['totalAmount']."','".$v['totalProfit']."','".$v['isCustomerDiscount']."','".$v['productUid']."','".json_encode($v['ticketitemattributes'])."','".time()."'); ";
