...
<head>
<TITLE>米贝管理中心-<?php echo (C("cms_name")); ?></TITLE>
...
<div class="topnav">
  <div class="sitenav">
    ...
    <div class=sitelink><a href="<?php echo U('Admin/Index/Index');?>" target="_parent">后台首页</a> | <a href="<?php echo (C("web_url")); ?>" target="_blank">网站主页</a> | <a class="top-txt" href="<?php echo U('Admin/Cache/delCore');?>" target="frmright" id="delcache">更新缓存</a><a id="cache"></a></div>
  </div>
  <div class="leftnav">
    <ul>
      <li class="navleft"></li>
